...
public final class ItemPetBinding implements ViewBinding {
  ...
  private ItemPetBinding(@NonNull LinearLayout rootView, @NonNull TextView textPetName) {
  ...
  public static ItemPetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.textPetName;
      TextView textPetName = ViewBindings.findChildViewById(rootView, id);
      if (textPetName == null) {
        break missingId;
      }

      return new ItemPetBinding((LinearLayout) rootView, textPetName);
    }
